...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<IRequestHandler<CreateBulkInscriptionCommand, Inscriptions.Models.BulkInscriptionDto>, CreateBulkInscriptionCommandHandler>();
        ...
        services.AddScoped<IRequestHandler<ListMembershipPaymentsQuery, PagedResult<Payments.Models.MembershipPaymentRowDto>>, ListMembershipPaymentsQueryHandler>();
        services.AddScoped<IRequestHandler<ImportMembershipPaymentsCommand, BulkImports.Models.BulkImportResultDto>, ImportMembershipPaymentsCommandHandler>();
